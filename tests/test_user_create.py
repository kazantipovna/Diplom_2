...
class TestUserCreate:
    ...
    def test_create_existing_user_expected_error(self, user):
        ...
        assert resp_codes_msg.codes[403][0] and resp_codes_msg.codes[403][2] in resp.text and resp.status_code == 403
    ...
    def test_create_user_empty_field(self, email, password, name):
        ...
        assert resp_codes_msg.codes[403][0] and resp_codes_msg.codes[403][1] in resp.text and resp.status_code == 403
